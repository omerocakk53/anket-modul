        ...
        >
          ...
          {ChartType !== "table" ? (
            <>
              ...
              {ChartType === "horizantalbar" && (
                <Bar
                  data={barData}
                  options={getChartOptions("horizantalbar")}
                />
              )}
              {ChartType === "pie" && (
                <Pie data={barData} options={pieOptions} />
              )}
              {ChartType === "line" && (
            ...
            <div className="rounded-xl border bg-gray-50 p-4 shadow-sm space-y-2">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="flex justify-center items-center px-3 py-2 border">
                        {parseFloat(itemData.period1Percent).toFixed(1)}%
                      </td>
                    </tr>
                    <tr>
                      <td className="px-3 py-2 border">Periyot 2</td>
                      <td className="flex justify-center items-center px-3 py-2 border">
                        {parseFloat(itemData.period2Percent).toFixed(1)}%
                      </td>
                    </tr>
                    <tr>
