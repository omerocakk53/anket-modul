    ...
    <div className="flex flex-col gap-6 max-w-md mx-auto p-4 bg-white rounded-lg shadow-md">
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          onChange={(e) =>
            handlePeriod1Change(periods.find((p) => p._id === e.target.value))
          }
        >
      ...
      <div className="flex flex-col">
        ...
        <select
          ...
          onChange={(e) =>
            handlePeriod2Change(periods.find((p) => p._id === e.target.value))
          }
        >
          <option value="">Seçiniz</option>
          {periods.map((period) => (
            <option
              ...
              className={
                period._id === selectedPeriod1?._id ? "text-gray-400" : ""
              }
            >
              {new Date(period.startDate).toLocaleDateString("tr-TR")} -{" "}
              {new Date(period.endDate).toLocaleDateString("tr-TR")}
