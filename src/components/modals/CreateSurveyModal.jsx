      ...
      <div className="tw-bg-white tw-w-full tw-max-w-xl tw-rounded-2xl tw-shadow-2xl tw-p-8 tw-relative tw-animate-fade-in">
        ...
        {currentStep === 1 && (
          <form onSubmit={handleSubmitStep1} className="tw-space-y-6">
            ...
            <div>
              <label className="tw-block tw-font-medium tw-text-neutral-700 tw-mb-1">
                Klasör
              </label>
              <input
                type="text"
                value={selectedGroup || ""}
                readOnly
                className="tw-w-full tw-px-4 tw-py-2 tw-bg-gray-100 tw-border tw-border-gray-300 tw-rounded-xl tw-text-neutral-800 tw-cursor-not-allowed"
              />
            </div>
        ...
        {currentStep === 2 && (
          <div className="tw-space-y-6">
            ...
            <div className="tw-bg-neutral-100 tw-p-4 tw-rounded-xl tw-space-y-2 tw-border tw-border-neutral-300">
              <p><strong>Klasör:</strong> <span className="tw-text-primary">{selectedGroup || "Seçilmedi"}</span></p>
