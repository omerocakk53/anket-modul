...
export default function SurveyFooter({ createdAt, lastModified, surveyType }) {
    ...
    const formattedLastModified = new Date(lastModified).toLocaleDateString('tr-TR', {
        day: '2-digit', month: 'long', year: 'numeric',
        hour: '2-digit', minute: '2-digit', second: '2-digit'
    });
    ...
    const getSurveyTypeText = (type) => {
        switch (type) {
            case 'MemberSatisfaction': return 'Üye Memnuniyet Anketi';
            case 'ActivitySatisfaction': return 'Etkinlik Memnuniyet Anketi';
            case 'EducationSatisfaction': return 'Eğitim Memnuniyet Anketi';
            case 'Normal': return 'Normal Anket';
            default: return 'Anket Tipi Yok';
        }
    };
