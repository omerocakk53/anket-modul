        ...
        <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative inline-block group">
                    ...
                    <div className="absolute -top-5 right-1 bg-black text-white text-xs px-3 py-1 rounded whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity z-50">
