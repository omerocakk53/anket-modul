...
const items = [
  ...
  { id: "rating", type: "Rating", iconKey: "FaStar", label: "Derecelendirme" },
  {
    ...
    type: "Link",
    iconKey: "FaLink",
    label: "Bağlantı/Site Adresi",
  },
  { id: "ranking", type: "Ranking", iconKey: "FaArrowUp", label: "Sıralama" },
  {
    id: "description",
    type: "Description",
    iconKey: "FaCommentAlt",
    label: "Açıklama",
  },
  {
    id: "file_upload",
    type: "FileUpload",
    iconKey: "FaFileUpload",
    label: "Dosya Yükleme",
  },
  {
    id: "payment",
  ...
  return (
    <>
      ...
      <div className="hidden lg:block p-4 border border-secondary-light w-full h-full shadow-xl bg-neutral/50 rounded-lg">
        ...
        <div className="mt-4">{renderButton(finishItem, true)}</div>
      </div>

      {/* Mobil için sağdan kayan menü */}
      {(sideBar || isClosing) && (
        <div
          className={`lg:hidden fixed top-0 right-0 h-full w-4/5 max-w-sm z-50 bg-white shadow-lg border-l border-gray-200 p-4 
