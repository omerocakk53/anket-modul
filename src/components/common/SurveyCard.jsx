...
export default function SurveyCard({ survey, handleDelete, handleCopyLink, handleShowQr, navigate }) {
    ...
    return (
        <div
            className="tw-bg-neutral-white tw-rounded-lg tw-shadow-md tw-border tw-border-neutral tw-p-6 tw-flex tw-flex-col tw-justify-between
 tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw-relative tw-overflow-hidden tw-cursor-pointer tw-h-[420px] tw-sm:h-70
 tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw- tw-hover:shadow-xl tw-transition-shadow tw-duration-300 tw-transform tw-hover:-translate-y-1"
